...
function SkeletonFeaturedCard() {
  return (
    <div className="h-full flex flex-col bg-neutral-900/60 rounded-xl border border-neutral-800/60 overflow-hidden animate-pulse">
      {/* Image Skeleton */}
      <div className="aspect-[16/9] bg-neutral-800 w-full"></div>
      ...
      <div className="p-5 md:p-6 flex flex-col flex-grow">
        ...
        <div className="mt-6 flex justify-between pt-4 border-t border-neutral-800/60">
...
function SkeletonSideCard() {
  return (
    <div className="flex gap-4 p-4 rounded-lg bg-neutral-900/40 border border-neutral-800/40 animate-pulse">
      {/* Thumbnail Skeleton */}
      <div className="flex-shrink-0 w-24 h-24 md:w-28 md:h-20 bg-neutral-800 rounded-lg"></div>
      
      {/* Text Skeleton */}
      <div className="flex flex-col flex-grow justify-center py-1">
        <div className="h-2.5 bg-neutral-800 rounded w-16 mb-3"></div>
        <div className="h-4 bg-neutral-800 rounded w-full mb-2"></div>
        <div className="h-4 bg-neutral-800 rounded w-3/4 mb-3"></div>
        <div className="h-2.5 bg-neutral-800 rounded w-20 mt-auto"></div>
      </div>
    </div>
  );
}
...
function SkeletonGridCard() {
  return (
    <div className="h-full flex flex-col bg-neutral-900/50 rounded-xl border border-neutral-800/50 overflow-hidden animate-pulse">
      {/* Thumbnail Skeleton */}
      <div className="aspect-[16/10] bg-neutral-800 w-full"></div>
      
      {/* Content Skeleton */}
      <div className="p-4 flex flex-col flex-grow">
        <div className="h-5 bg-neutral-800 rounded w-full mb-2"></div>
        <div className="h-5 bg-neutral-800 rounded w-4/5 mb-4"></div>
        ...
        <div className="flex justify-between pt-3 border-t border-neutral-800/40">
          <div className="h-2.5 bg-neutral-800 rounded w-16"></div>
          <div className="h-2.5 bg-neutral-800 rounded w-12"></div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section className="newspaper-bg w-full mt-0 relative z-10">
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex gap-3 overflow-hidden animate-pulse">
        {[1, 2, 3, 4, 5, 6].map(i => (
          <div key={i} className="h-9 bg-neutral-800 rounded-full w-24 flex-shrink-0"></div>
        ))}
      </div>
